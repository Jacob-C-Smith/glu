...
enum segment_access_bits_e
{
    ...
    SEGMENT_ACCESS_KERNEL_CODE =   SEGMENT_ACCESS_PRESENT        | SEGMENT_ACCESS_PRIVILEGE_KERNEL     & SEGMENT_ACCESS_PRIVILEGE_KERNEL | SEGMENT_ACCESS_TYPE_CODE_DATA
                                 | SEGMENT_ACCESS_CODE_DATA_CODE | SEGMENT_ACCESS_CODE_EQUAL_PRIVILEGE | SEGMENT_ACCESS_DATA_WRITE_ALLOW | SEGMENT_ACCESS_UNACCESSED,

    SEGMENT_ACCESS_KERNEL_DATA =   SEGMENT_ACCESS_PRESENT        | SEGMENT_ACCESS_PRIVILEGE_KERNEL     & SEGMENT_ACCESS_PRIVILEGE_KERNEL | SEGMENT_ACCESS_TYPE_CODE_DATA
                                 | SEGMENT_ACCESS_CODE_DATA_DATA | SEGMENT_ACCESS_CODE_EQUAL_PRIVILEGE | SEGMENT_ACCESS_DATA_WRITE_ALLOW | SEGMENT_ACCESS_UNACCESSED,

    SEGMENT_ACCESS_USER_CODE   =   SEGMENT_ACCESS_PRESENT        | SEGMENT_ACCESS_PRIVILEGE_USER       & SEGMENT_ACCESS_PRIVILEGE_KERNEL | SEGMENT_ACCESS_TYPE_CODE_DATA
                                 | SEGMENT_ACCESS_CODE_DATA_CODE | SEGMENT_ACCESS_CODE_EQUAL_PRIVILEGE | SEGMENT_ACCESS_DATA_WRITE_ALLOW | SEGMENT_ACCESS_UNACCESSED,
                                 
    SEGMENT_ACCESS_USER_DATA   =   SEGMENT_ACCESS_PRESENT        | SEGMENT_ACCESS_PRIVILEGE_USER       & SEGMENT_ACCESS_PRIVILEGE_KERNEL | SEGMENT_ACCESS_TYPE_CODE_DATA
                                 | SEGMENT_ACCESS_CODE_DATA_DATA | SEGMENT_ACCESS_CODE_EQUAL_PRIVILEGE | SEGMENT_ACCESS_DATA_WRITE_ALLOW | SEGMENT_ACCESS_UNACCESSED
};
